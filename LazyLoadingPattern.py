...
def getCurrentProcessMemoryUsage():
...
print("\nMemory used before loading the objects:",getCurrentProcessMemoryUsage() , "MiBs")
...
print("Memory used after loading the objects:", getCurrentProcessMemoryUsage(), "MiBs\n")
